...
#bash -c 'echo "2;0x0;0x0;288" > /tmp/memhack_in; cat /tmp/memhack_out' &
#bash -c 'echo "3;0x7b0000;0x850000;288;0x404d50;0x425c88" > /tmp/memhack_in; cat /tmp/memhack_out' &
bash -c 'echo "4;0x0;0x0;288;0x404d50;0x425c88;0x411097" > /tmp/memhack_in; cat /tmp/memhack_out' &
